namespace RestaurantsPlatform.Seed.Seeding
{
    ...
    public class CategorySeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            CategoryImage cafeteria = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1585916185/restaurant/categories/cafeteria/Cafeteria_ety9so.jpg");
            CategoryImage casualDining = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1586207894/restaurant/categories/casual-dining/CasualDining_hpng6o.jpg");
            CategoryImage ethnic = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1586207925/restaurant/categories/ethnic/Ethnic_ere5s0.jpg");
            CategoryImage familyStyle = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1586207928/restaurant/categories/family-style/FamilyStyle_brz7mq.jpg");
            CategoryImage fastFood = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1586207933/restaurant/categories/fast-food/FastFood_a5r5fa.jpg");
            CategoryImage fineDining = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1586207939/restaurant/categories/fine-dining/FineDining_lwyokf.jpg");
            CategoryImage premiumCasual = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1586207943/restaurant/categories/premium-casual/PremiumCasual_xjynce.jpg");
            CategoryImage pub = dbContext.CategoryImages.FirstOrDefault(image => image.ImageUrl == "https://res.cloudinary.com/djlskbceh/image/upload/v1586207865/restaurant/categories/pub/Pub_ihqbd2.jpg");
