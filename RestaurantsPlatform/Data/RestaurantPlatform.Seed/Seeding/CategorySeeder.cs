namespace RestaurantsPlatform.Seed.Seeding
{
    ...
    public class CategorySeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            var ethnic = dbContext.Images.First(image => image.AlternativeText == "Ethnic");
            var fastFood = dbContext.Images.First(image => image.AlternativeText == "Fast food");
            var casualDining = dbContext.Images.First(image => image.AlternativeText == "Casual dining");
            var premiumCasual = dbContext.Images.First(image => image.AlternativeText == "Premium casual");
            var familyStyle = dbContext.Images.First(image => image.AlternativeText == "Family style");
            var fineDining = dbContext.Images.First(image => image.AlternativeText == "Fine dining");
            var cafeteria = dbContext.Images.First(image => image.AlternativeText == "Cafeteria");
            var pub = dbContext.Images.First(image => image.AlternativeText == "Pub");
